...
summary: 'Retrieve vVol bindings'
---

= Retrieve vVol bindings

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/protocols/san/vvol-bindings`#
...
|query
|False
a|Filter by protocol_endpoint.uuid
...
|query
|False
a|Filter by protocol_endpoint.name
...
|name
|string
a|The fully qualified path name of the LUN composed of the "/vol" prefix, the volume name, the (optional) qtree name, and base name of the LUN. Valid in POST and PATCH.
