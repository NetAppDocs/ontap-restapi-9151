...
summary: 'Retrieve all UNIX users for all SVMs'
---

= Retrieve all UNIX users for all SVMs

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/name-services/unix-users`#
