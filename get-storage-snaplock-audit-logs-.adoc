...
summary: 'Retrieve SnapLock audit logs'
---

= Retrieve SnapLock audit logs

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/storage/snaplock/audit-logs/{svm.uuid}`#
