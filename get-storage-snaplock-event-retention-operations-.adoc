...
summary: 'Retrieve attributes for an EBR operation'
---

= Retrieve attributes for an EBR operation

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/storage/snaplock/event-retention/operations/{id}`#
