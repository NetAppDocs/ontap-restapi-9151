...
summary: 'Retrieve the tags currently used for resources'
---

= Retrieve the tags currently used for resources

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/resource-tags`#

*Introduced In:* 9.13

Retrieves the tags currently being used for resources in the API.
...
|records
|array[link:#resource_tag[resource_tag]]
a|
...
A resource tag is a way to group resources in the API together for identification or tracking purposes.
