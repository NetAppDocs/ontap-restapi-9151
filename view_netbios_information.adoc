...
# The call:
curl -X GET "https://<mgmt-ip>/api/protocols/cifs/netbios?return_timeout=15&fields=*&return_records=true" -H  "accept: application/json" -H  "authorization: Basic <CREDENTIALS>"
...
# The call:
curl -X GET "https://<mgmt-ip>/api/protocols/cifs/netbios?svm.uuid=45a3bd71-777f-11ec-95a1-1315568ef5fd&return_timeout=15&fields=*&return_records=true" -H  "accept: application/json" -H  "authorization: Basic <CREDENTIALS>"
