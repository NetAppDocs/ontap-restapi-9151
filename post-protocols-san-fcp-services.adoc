...
api: true
explorer: false
permalink: 'post-protocols-san-fcp-services.html'
summary: 'Create an FC protocol service'
---

= Create an FC protocol service

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/protocols/san/fcp/services`#
...
|records
|array[link:#fcp_service[fcp_service]]
a|
...
| 1115127
| The cluster lacks a valid FC Protocol license.
...
| 5374092
| The Fibre Channel Protocol is not supported on the cluster hardware configuration; there are no Fibre Channel adapters.
