...
api: true
explorer: false
permalink: 'post-application-applications-components-snapshots.html'
summary: 'Create an application component Snapshot copy'
---

= Create an application component Snapshot copy

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/application/applications/{application.uuid}/components/{component.uuid}/snapshots`#
