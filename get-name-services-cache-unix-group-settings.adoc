...
api: true
explorer: false
permalink: 'get-name-services-cache-unix-group-settings.html'
summary: 'Retrieve UNIX group cache settings'
---

= Retrieve UNIX group cache settings

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/name-services/cache/unix-group/settings`#
...
|records
|array[link:#unix_group_settings[unix_group_settings]]
a|
