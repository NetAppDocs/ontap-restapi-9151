...
summary: 'Update the DNS domain and server configuration for an SVM'
---

= Update the DNS domain and server configuration for an SVM

[.api-doc-operation .api-doc-operation-patch]#PATCH# [.api-doc-code-block]#`/name-services/dns/{uuid}`#
...
|service_ips
|array[string]
a|List of IP addresses for a DNS service. Addresses can be IPv4, IPv6 or both.
