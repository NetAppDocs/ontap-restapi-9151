...
a|Properties related to initator group replication.
...
| 5374765
| An initiator group cannot be replicated if it has unreplicated child initiatior groups.

| 5374766
| A replicated initiator group cannot be changed to unreplicated if it is the child of a replicated initiatior group.
