...
summary: 'Retrieve historical performance metrics for an NVMe namespace'
---

= Retrieve historical performance metrics for an NVMe namespace

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/storage/namespaces/{nvme_namespace.uuid}/metrics`#
