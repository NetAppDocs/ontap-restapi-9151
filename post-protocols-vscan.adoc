...
api: true
explorer: false
permalink: 'post-protocols-vscan.html'
summary: 'Create a Vscan configuration'
---

= Create a Vscan configuration

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/protocols/vscan`#
...
|on_demand_policies
|array[link:#vscan_on_demand_policy[vscan_on_demand_policy]]
a|

|scanner_pools
|array[link:#scanner_pool[scanner_pool]]
a|
