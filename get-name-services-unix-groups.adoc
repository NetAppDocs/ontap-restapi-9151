...
summary: 'Retrieve UNIX groups for all SVMs'
---

= Retrieve UNIX groups for all SVMs

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/name-services/unix-groups`#
...
|current_count
|integer
a|Number of UNIX groups and members.


|num_records
|integer
a|Number of UNIX group records.


|records
|array[link:#unix_group[unix_group]]
a|
