...
| 13304011
| Failed to create or modify the specified Snapmirror policy. Reason: The propery retention.count cannot have a value greater than 1.
...
|count
|integer
a|Number of Snapshot copies to be kept for retention. Maximum value will differ based on type of relationship and scaling factor.
