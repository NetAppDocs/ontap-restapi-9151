...
summary: 'Retrieve the NFS configuration for an SVM'
---
...
|trunking_enabled
|boolean
a|Flag that indicates the trunking status for the specified SVM connection. True indicates that the trunking feature is enabled while false indicates that the trunking feature is disabled.
