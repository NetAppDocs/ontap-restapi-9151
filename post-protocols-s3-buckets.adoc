...
api: true
explorer: false
permalink: 'post-protocols-s3-buckets.html'
summary: 'Create the S3 bucket configuration for an SVM'
---

= Create the S3 bucket configuration for an SVM

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/protocols/s3/buckets`#
