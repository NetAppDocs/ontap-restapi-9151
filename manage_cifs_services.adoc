...
# The call:
curl -X GET "https://<mgmt-ip>/api/protocols/cifs/services?fields=*&return_records=true&return_timeout=15" -H "accept: application/json" -H "authorization: Basic <CREDENTIALS>"
...
# The call:
curl -X GET "https://<mgmt-ip>/api/protocols/cifs/services/e0c20d9c-96cd-11eb-97da-0050568e684d" -H "accept: application/json" -H "authorization: Basic <CREDENTIALS>"
...
# The call:
curl -X PATCH "https://<mgmt-ip>/api/protocols/cifs/services/e0c20d9c-96cd-11eb-97da-0050568e684d" -H "accept: application/json" -H "authorization: Basic <CREDENTIALS>" -H "Content-Type: application/json" -d "{ \"comment\": \"CIFS SERVER MODIFICATION\"}"
----
...
# The call:
curl -X DELETE "https://<mgmt-ip>/api/protocols/cifs/services/e0c20d9c-96cd-11eb-97da-0050568e684d" -H "accept: application/json" -H "authorization: Basic <CREDENTIALS>" -H "Content-Type: application/json" -d "{ \"ad_domain\": { \"fqdn\": \"ontapavc.com\", \"organizational_unit\": \"CN=Computers\", \"password\": \"<PASSWORD-FOR-USER>\", \"user\": \"administrator\" }, \"force\": true}"

# The call when using AKV:
curl -X DELETE "https://<mgmt-ip>/api/protocols/cifs/services/e0c20d9c-96cd-11eb-97da-0050568e684d" -H "accept: application/json" -H "authorization: Basic <CREDENTIALS>" -H "Content-Type: application/json" -d "{ \"key_vault_uri\": \"https://testkv.vault.azure.net\", \"client_secret\": \"<AWS-SECRET-ACCESS-KEY>\", \"authentication_method\": \"client_secret\", \"tenant_id\": \"c9f32fcb-4ab7-40fe-af1b-1850d46cfbbe\", \"client_id\": \"e959d1b5-5a63-4284-9268-851e30e3eceb\", \"ad_domain\": { \"fqdn\": \"ontapavc.com\", \"organizational_unit\": \"CN=Computers\" , \"user\": \"administrator\" }, \"force\": true}"
----
