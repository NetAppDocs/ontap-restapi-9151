...
//end row
//start row
|The policy is not valid for relationships with FlexGroup volume endpoints. Only policies without Snapshot copy creation schedules are supported for these relationships.
//end row
//start row
|
//end row
...
//end row
//start row
|SnapMirror Asynchronous relationship is not supported on a Consistency Group volume that has Snapshot copy locking enabled.
//end row
//start row
|
//end row
