...
api: true
explorer: false
permalink: 'post-protocols-audit-object-store.html'
summary: 'Create an S3 audit configuration'
---

= Create an S3 audit configuration

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/protocols/audit/{svm.uuid}/object-store`#
