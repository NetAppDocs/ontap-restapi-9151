...
|query
|False
a|The string required to look up the SRV record on the DNS server.

* Introduced in: 9.14


|service.address_type
|string
|query
|False
a|The type of IP address to be looked up on the DNS server.
