...
api: true
explorer: false
permalink: 'get-name-services-cache-host-settings.html'
summary: 'Retrieve host cache settings'
---

= Retrieve host cache settings

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/name-services/cache/host/settings`#
...
* link:manage_host_cache_settings.html[DOC /name-services/cache/host/settings]
...
|records
|array[link:#hosts_settings[hosts_settings]]
a|
...
|dns_ttl_enabled
|boolean
a|Specifies whether TTL is based on the DNS or host settings. If enabled, TTL from DNS is used.
