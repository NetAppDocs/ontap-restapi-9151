...
summary: 'Retrieve UNIX user cache settings'
---

= Retrieve UNIX user cache settings

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/name-services/cache/unix-user/settings`#
...
|records
|array[link:#unix_user_settings[unix_user_settings]]
a|
