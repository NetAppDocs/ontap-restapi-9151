...
|clone
|link:#clone[clone]
a|Creates a clone of an existing consistency group from the current contents or an existing Snapshot copy.
...
|split_initiated
|boolean
a|Splits volumes after cloning. Default is false.
...
|show_snapshot
|boolean
a|Specifies whether or not the Snapshot copies can be viewed and traversed by clients.
