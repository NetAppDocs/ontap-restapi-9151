...
summary: 'Retrieve broadcast domains for the entire cluster'
---

= Retrieve broadcast domains for the entire cluster

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/network/ethernet/broadcast-domains`#
...
|records
|array[link:#broadcast_domain[broadcast_domain]]
a|
