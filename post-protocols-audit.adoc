...
api: true
explorer: false
permalink: 'post-protocols-audit.html'
summary: 'Create an audit configuration'
---

= Create an audit configuration

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/protocols/audit`#
...
|guarantee
|boolean
a|Indicates whether there is a strict Guarantee of Auditing
