...
summary: 'Retrieve a shadow copy set'
---

= Retrieve a shadow copy set

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/protocols/cifs/shadowcopy-sets/{uuid}`#
