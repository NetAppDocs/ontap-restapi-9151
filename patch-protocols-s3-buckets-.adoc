...
api: true
explorer: false
permalink: 'patch-protocols-s3-buckets-.html'
summary: 'Update the S3 bucket configuration for an SVM'
---

= Update the S3 bucket configuration for an SVM

[.api-doc-operation .api-doc-operation-patch]#PATCH# [.api-doc-code-block]#`/protocols/s3/buckets/{svm.uuid}/{uuid}`#
