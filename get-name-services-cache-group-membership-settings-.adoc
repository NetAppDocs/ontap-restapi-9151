...
summary: 'Retrieve a group membership cache setting for an SVM'
---

= Retrieve a group membership cache setting for an SVM

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/name-services/cache/group-membership/settings/{svm.uuid}`#
