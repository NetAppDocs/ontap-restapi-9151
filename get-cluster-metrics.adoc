...
api: true
explorer: false
permalink: 'get-cluster-metrics.html'
summary: 'Retrieve historical performance metrics for the cluster'
---

= Retrieve historical performance metrics for the cluster

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/cluster/metrics`#
...
|query
|False
a|The time range for the data. Examples can be 1h, 1d, 1m, 1w, or 1y.
