...
# The call:
curl -k https://<mgmt-ip>/api/security/authentication/duo/profiles --request POST --data '{"api_host": "api-******.duosecurity.com",  "comment": "test post",  "fail_mode": "safe",  "integration_key": "<INTEGRATION-KEY>", "secret_key": "<SECRET-KEY>"}'
...
# The call:
curl -k https://<mgmt-ip>/api/security/authentication/duo/profiles --request POST --data '{"api_host": "api-******.duosecurity.com",  "comment": "test post",  "fail_mode": "safe",  "integration_key": "<INTEGRATION-KEY>", "secret_key": "<SECRET-KEY>", "owner.name":"vs0" }'
