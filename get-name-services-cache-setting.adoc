...
api: true
explorer: false
permalink: 'get-name-services-cache-setting.html'
summary: 'Retrieve a global name service cache setting'
---

= Retrieve a global name service cache setting

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/name-services/cache/setting`#
...
|query
|False
a|Filter by eviction_time_interval
...
|query
|False
a|Filter by remote_fetch_enabled
