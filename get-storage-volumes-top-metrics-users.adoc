...
api: true
explorer: false
permalink: 'get-storage-volumes-top-metrics-users.html'
summary: 'Retrieve users with the most I/O activity'
---

= Retrieve users with the most I/O activity

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/storage/volumes/{volume.uuid}/top-metrics/users`#
...
|records
|array[link:#top_metrics_user[top_metrics_user]]
a|
