...
api: true
explorer: false
permalink: 'get-cluster-nodes-metrics.html'
summary: 'Retrieve node historical performance metrics'
---

= Retrieve node historical performance metrics

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/cluster/nodes/{uuid}/metrics`#
...
|query
|False
a|Filter by processor_utilization
