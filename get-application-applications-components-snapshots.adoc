...
summary: 'Retrieve application component Snapshot copies'
---

= Retrieve application component Snapshot copies

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/application/applications/{application.uuid}/components/{component.uuid}/snapshots`#
...
|query
|False
a|Filter by Application Component Name
...
|records
|array[link:#application_component_snapshot[application_component_snapshot]]
a|
