...
api: true
explorer: false
permalink: 'get-storage-volumes-top-metrics-files.html'
summary: 'Retrieve files with the most I/O activity'
---

= Retrieve files with the most I/O activity

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/storage/volumes/{volume.uuid}/top-metrics/files`#
...
|records
|array[link:#top_metrics_file[top_metrics_file]]
a|
