...
//end row
//start row
|Failed to create s3 policy statements. Reason: "{reason of failure}". Valid ways to specify a resource are "__", "+++<bucket-name>+++", "+++<bucket-name>+++/\.../\...".". Resolve all the issues and retry the operation. //end row |=== //end table+++</bucket-name>++++++</bucket-name>+++
