...
*** REST APIs follows https://datatracker.ietf.org/doc/html/rfc3986#section-5.2.4[RFC3986 Section 5.2.4] regarding relative reference resolution.
...
In accordance with https://datatracker.ietf.org/doc/html/rfc3986#section-5.2.4[RFC3986 Section 5.2.4], ONTAP REST API removes dot segments to resolve the path. The examples below describe this behavior.
...
The following error codes can be returned by any ONTAP REST endpoint. Refer to individual endpoint documentation for additional endpoint specific error codes.
...
| 262160
| There are too many requests already being processed. Retry after a short delay.
| 429
...
| 262203
| Field is not supported in the body of a PATCH request.
| 400
...
| 262222
| Specified value is listed more than once for this field.
| 400
...
| 263149
| Resource tag limit was reached while creating or modifying the resource.
| 400
...
| 1245212
| Insufficient space available to complete the operation.
| 500
...
| 2621471
| An invalid SVM name was specified.
| 400
...
| 2621576
| Configuration changes for a locked SVM are not permitted.
| 409
...
| 2621706
| The specified values refer to different SVMs.
| 400
...
=== Tagging Resources for Tracking Purposes
