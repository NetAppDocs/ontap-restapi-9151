...
api: true
explorer: false
permalink: 'patch-protocols-san-iscsi-services-.html'
summary: 'Update an iSCSI service'
---

= Update an iSCSI service

[.api-doc-operation .api-doc-operation-patch]#PATCH# [.api-doc-code-block]#`/protocols/san/iscsi/services/{svm.uuid}`#
...
|path
|True
a|The unique identifier of the SVM for which to update the iSCSI service.
