...
api: true
explorer: false
permalink: 'delete-application-applications-components-snapshots-.html'
summary: 'Delete an application component Snapshot copy'
---

= Delete an application component Snapshot copy

[.api-doc-operation .api-doc-operation-delete]#DELETE# [.api-doc-code-block]#`/application/applications/{application.uuid}/components/{component.uuid}/snapshots/{uuid}`#

*Introduced In:* 9.6

Delete a Snapshot copy of an application component.
...
* link:delete-application-applications-snapshots.html[DELETE /application/applications/\{uuid}/snapshots]
