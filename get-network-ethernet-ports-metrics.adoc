...
api: true
explorer: false
permalink: 'get-network-ethernet-ports-metrics.html'
summary: 'Retrieve historical port performance metrics'
---

= Retrieve historical port performance metrics

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/network/ethernet/ports/{uuid}/metrics`#
