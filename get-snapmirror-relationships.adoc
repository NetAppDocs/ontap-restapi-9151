...
|query
|False
a|Filter by transfer.last_updated_time
...
|query
|False
a|Filter by svmdr_volumes.name
...
|query
|False
a|Filter by total_transfer_bytes
...
|query
|False
a|Filter by total_transfer_duration
...
|query
|False
a|Filter by last_transfer_network_compression_ratio
...
|query
|False
a|Filter by unhealthy_reason.arguments
...
|query
|False
a|Filter by consistency_group_failover.state
...
|query
|False
a|Filter by consistency_group_failover.type
...
|query
|False
a|Filter by master_bias_activated_site
