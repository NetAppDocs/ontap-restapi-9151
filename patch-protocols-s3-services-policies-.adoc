...
api: true
explorer: false
permalink: 'patch-protocols-s3-services-policies-.html'
summary: 'Update an S3 policy configuration'
---

= Update an S3 policy configuration

[.api-doc-operation .api-doc-operation-patch]#PATCH# [.api-doc-code-block]#`/protocols/s3/services/{svm.uuid}/policies/{name}`#
...
//end row
//start row
|Failed to modify policy statement for policy "{policy name}". Reason: "{reason of failure}". Valid ways to specify a resource are "__", "+++<bucket-name>+++", "+++<bucket-name>+++/\.../\...".". //end row |=== //end table+++</bucket-name>++++++</bucket-name>+++
