...
api: true
explorer: false
permalink: 'post-application-applications-snapshots-restore.html'
summary: 'Restore an application Snapshot copy'
---

= Restore an application Snapshot copy

[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/application/applications/{application.uuid}/snapshots/{uuid}/restore`#
